                                ...
                                <div class="nav-tabs-wrapper">
                                    <ul class="nav nav-tabs" style="background: #49C5B6;" data-tabs="tabs">
                                        <li class="nav-item">
                                            ...
                                            <i class="fa  fa-2x fa-television" aria-hidden="true"></i> vm.cable
                                        ...
                                        <form role="form" ng-submit="vm.submitFormCable()" id="contact-form">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" name="name" ng-model="vm.cable.name" class="form-control">
                                                </div>
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Mobile No</label>
                                                    <input type="text" name="phone" ng-model="vm.cable.phone" class="form-control" />
                                                </div>
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Email</label>
                                                    <input type="text" name="email" ng-model="vm.cable.email" class="form-control" />
                                                </div>
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Address</label>
                                                    <textarea name="address" class="form-control" ng-model="vm.cable.address" id="address" rows="6"></textarea>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" name="name" ng-model="vm.cable.stbNO" class="form-control">
                                                </div>
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Operator</label>
                                                    <input type="text" name="phone" ng-model="vm.cable.operator" class="form-control" />
                                                </div>
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Type</label>
                                                    <select class="form-control" ng-model="vm.cable.type">
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <textarea name="address" class="form-control" ng-model="vm.cable.description" id="address" rows="6"></textarea>
                                                </div>
                                            </div>
                                            <div class="row">
                                    ...
                                    <div class="row">
                                        <form role="form" id="contact-form" ng-submit="vm.broadbandForm()">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Name</label>
                                                    <input type="text" name="name" ng-model="vm.broadband.name" class="form-control">
                                                </div>
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Mobile No</label>
                                                    <input type="email" name="phone" ng-model="vm.broadband..phone" class="form-control" />
                                                </div>
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Email</label>
                                                    <input type="text" name="email" ng-model="vm.broadband..email" class="form-control" />
                                                </div>
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Address</label>
                                                    <textarea name="address" class="form-control" ng-model="vm.broadband..address" id="address" rows="6"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <h3>Other Information</h3>
                                                ...
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Description</label>
                                                    <textarea ng-model="vm.broadband.description" name="description" class="form-control" rows="3"></textarea>
                                                </div>
                                            </div>
