<div id="carousel-example-generic"  ng-controller="HomeController as vm" class="carousel slide" data-ride="carousel">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
                ...
                <h4>A world-class service with more channels, interactive features & value added services at reasonable prices</h4>
            </div>
        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="info info-horizontal">
                    ...
                    <div class="description">
                        <h4 class="info-title">Quick Bill Pay</h4>
                ...
                <div class="info info-horizontal">
                    ...
                    <div class="description">
                        <h4 class="info-title">Inquiry</h4>
                ...
                <div class="info info-horizontal">
                    ...
                    <div class="description">
                        <h4 class="info-title">Customer Service</h4>
                        <p>Divide details about your product or agency work into parts. Write a few lines about each one. A
                            paragraph describing a feature will be enough.</p>
                    </div>
                </div>
